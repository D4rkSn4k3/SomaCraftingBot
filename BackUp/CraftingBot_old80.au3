...
Func Test()
	ToolTip(GUICtrlRead($ItemsSelectAction))
EndFunc   ;==>Test
...
Func AddPotionCraftingToScript() ;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<=========
	...
	$IsInt = IsInt(GUICtrlRead($ItemID1))
	If $IsInt = 0 Then
		MsgBox(0, "ItemID 1", "Please input a value - Press ALT + S and Column 0 to see ItemIDs of your inventory.")
	ElseIf $IsInt = 1 Then
		$SA[$SA[0][0]][1] = GUICtrlRead($ItemID1)
		$IsInt = ""
	EndIf
	$IsInt = IsInt(GUICtrlRead($ItemID2))
	If $IsInt = 0 Then
		MsgBox(0, "ItemID 2", "Please input a value - Press ALT + S and Column 0 to see ItemIDs of your inventory.")
	ElseIf $IsInt = 1 Then
		$SA[$SA[0][0]][2] = GUICtrlRead($ItemID2)
		$IsInt = ""
	EndIf
	$IsInt = IsInt(GUICtrlRead($ItemID3))
	If $IsInt = 0 Then
		MsgBox(0, "ItemID 3", "Please input a value - Press ALT + S and Column 0 to see ItemIDs of your inventory.")
	ElseIf $IsInt = 1 Then
		$SA[$SA[0][0]][3] = GUICtrlRead($ItemID3)
		$IsInt = ""
	EndIf
	$IsInt = IsInt(GUICtrlRead($ItemID4))
	If $IsInt = 0 Then
		MsgBox(0, "ItemID 4", "Please input a value - Press ALT + S and Column 0 to see ItemIDs of your inventory.")
	ElseIf $IsInt = 1 Then
		$SA[$SA[0][0]][4] = GUICtrlRead($ItemID4)
		$IsInt = ""
	EndIf
	$IsInt = IsInt(GUICtrlRead($Amount1))
	If $IsInt = 0 Then
		MsgBox(0, "Amount 1", "Please input a value")
	ElseIf $IsInt = 1 Then
		$SA[$SA[0][0]][1] = GUICtrlRead($Amount1)
		$IsInt = ""
	EndIf
	$IsInt = IsInt(GUICtrlRead($Amount2))
		If $IsInt = 0 Then
		MsgBox(0, "Amount 2", "Please input a value")
	ElseIf $IsInt = 1 Then
		$SA[$SA[0][0]][2] = GUICtrlRead($Amount2)
		$IsInt = ""
	EndIf
	$IsInt = IsInt(GUICtrlRead($Amount3))
		If $IsInt = 0 Then
		MsgBox(0, "Amount 3", "Please input a value")
	ElseIf $IsInt = 1 Then
		$SA[$SA[0][0]][3] = GUICtrlRead($Amount3)
		$IsInt = ""
	EndIf
	$IsInt = IsInt(GUICtrlRead($Amount4))
		If $IsInt = 0 Then
		MsgBox(0, "Amount 4", "Please input a value")
	ElseIf $IsInt = 1 Then
		$SA[$SA[0][0]][4] = GUICtrlRead($Amount4)
		$IsInt = ""
	EndIf
