...
;~ 	$SendKeyLabel = GUICtrlCreateListView("Oneeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee", 16, 16, 209, 227, BitOR($GUI_SS_DEFAULT_LISTVIEW, $LVS_NOCOLUMNHEADER))
