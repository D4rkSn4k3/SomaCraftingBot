...
;~ 	$SendKeyList = GUICtrlCreateListView("Oneeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee", 16, 16, 209, 227, BitOR($GUI_SS_DEFAULT_LISTVIEW, $LVS_NOCOLUMNHEADER))
	$SendKeyList = GUICtrlCreateEdit("05 X1 mouse button" & @CRLF & _
			...
			"5C Right Windows key pad 0 key" & @CRLF & _
			"61 Numeric key pad 1 key" & @CRLF & _
			"62 Numeric key pad 2 key" & @CRLF & _
			"63 Numeric key pad 3 key" & @CRLF & _
			"64 Numeric key pad 4 key" & @CRLF & _
			"65 Numeric key pad 5 key" & @CRLF & _
			"66 Numeric key pad 6 key" & @CRLF & _
			"67 Numeric key pad 7 key" & @CRLF & _
			"68 Numeric key pad 8 key" & @CRLF & _
			"69 Numeric key pad 9 key" & @CRLF & _
			"6A Multiply key 6B Add key" & @CRLF & _
			"6C Separator key 6D Subtract key" & @CRLF & _
			"6E Decimal key 6F Divide key" & @CRLF & _
			"70 F1 key" & @CRLF & _
			"71 F2 key" & @CRLF & _
			"72 F3 key" & @CRLF & _
			"73 F4 key" & @CRLF & _
			...
			"7A F11 key" & @CRLF & _
			"7B F12 key" & @CRLF & _
			"7C-7F F13 key - F16 key" & @CRLF & _
			"80H-87H F17 key - F24 key" & @CRLF & _
			...
			"A4 Left MENU key" & @CRLF & _
			"A5 Right MENU key" & @CRLF & _
			"BA ;" & @CRLF & _
			"BB =" & @CRLF & _
			"BC ," & @CRLF & _
			"BD -" & @CRLF & _
			...
			"DB [" & @CRLF & _
			"DC \" & @CRLF & _
			"DD ]", 16, 16, 209, 227, $ES_AUTOVSCROLL + $WS_VSCROLL)
	...
	GUICtrlSetData($ItemsSelectAction, "Craft: Potion Table")
...
Func SelectNPCButton()
	...
	While $SelectTargetMobLoop = 1
		...
		EndIf
		For $i = 0 To 38 Step 1
			If $EA[$i][6] = 0 And $EA[$i][0] <> 27206 And $EA[$i][0] = $TargetMob Then
