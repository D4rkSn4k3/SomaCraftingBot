...
Func ScanShopInventoryArrayDisplay()
	ScanShopInventory()
	_ArrayDisplay($ScanShopInventory, "Shop Inventory")
...
Func ScanShopInventory()
	...
	For $i = 1 To UBound($ScanShopInventory) - 1 Step 1
		...
		EndIf
		$ScanShopInventory[$i][0] = _KDMemory_ReadProcessMemory($handles, 0x0536258, 'WORD', $ScanShopInventoryIDOffset)
		$ScanShopInventory[$i][1] = _KDMemory_ReadProcessMemory($handles, 0x0536258, 'char[30]', $ScanShopInventoryNameOffset)
		$ScanShopInventory[$i][2] = _KDMemory_ReadProcessMemory($handles, 0x0536258, 'WORD', $ScanShopInventoryWeightOffset)
		$ScanShopInventory[$i][3] = _KDMemory_ReadProcessMemory($handles, 0x0536258, 'WORD', $ScanShopInventoryDuraAmountOffset)
	Next
