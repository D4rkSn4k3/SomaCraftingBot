...
;~ 		For $i = 0 To UBound($IniSectionNames) - 1
;~ 			MsgBox(0, "", $IniSectionNames[$i])
;~ 		Next
if $IniSectionNames > UBound($ScriptViewListArray, 1) Then
	for $d = UBound($ScriptViewListArray, 1) to $IniSectionNames step 1
	IniDelete($sFileSaveDialog,$d)
	next
	endif
