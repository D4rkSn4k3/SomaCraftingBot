...
Func LoadScript()
	...
	Else
		...
		For $d = 0 To $IniSectionNames[0] - 1 Step 1
...
;~ 									msgbox(0,"",UBound($ScriptViewListArray, 2))
					ReDim $ScriptViewListArray[UBound($ScriptViewListArray)][$Section[0][0]+2]
;~ 									msgbox(0,"",UBound($ScriptViewListArray, 2))
				EndIf
