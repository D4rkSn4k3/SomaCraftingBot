...
Func Gui()
	...
	;ScriptViewList
	$ScriptViewList = GUICtrlCreateListView("", 8, 264, 425, 136)
...
$ScriptViewListArray[$ScriptViewListArray[0][0]][0] = "["&$ScriptViewListArray[0][0]&"]"&"Navigate "&$NavNodes[0][0]&" Nodes"
	Next
	GuiUpdate()
;~   GUICtrlCreateListViewItem("Navigate " & $NavNodes[0][0] & " Nodes", $ScriptViewList)
;~  $item1 = GUICtrlCreateListViewItem("item1", $ScriptViewList)
;~ GUICtrlSetData($ScriptViewList,)
;~ _GUICtrlListView_SortItems ( $ScriptViewList, 1 )
EndFunc   ;==>AddNavNodesToScript

Func UpdateScriptList()

EndFunc   ;==>UpdateScriptList
