...
;~ 	msgbox(0,"",$NavNodes[0][0])
;~ 	ReDim $ScriptViewListArray[UBound($ScriptViewListArray) + 1][($NavNodes[0][0] * 2) + 2]
;~ Global $ubound = UBound($ScriptViewListArray)
;~ msgbox(0,"",UBound($ScriptViewListArray[0][0]))
;~ msgbox(0,"",$ubound)
	If ($NavNodes[0][0] * 2) + 1 > UBound($ScriptViewListArray, 2) Then
		tooltip("NavNode Greater than current array size")
		ReDim $ScriptViewListArray[UBound($ScriptViewListArray) + 1][($NavNodes[0][0] * 2) + 2]
	Else
			ReDim $ScriptViewListArray[UBound($ScriptViewListArray) + 1][UBound($ScriptViewListArray, 2)]

;~ 		tooltip("NavNode Smaller than current array size)
;~ 		ReDim $ScriptViewListArray[UBound($ScriptViewListArray) + 1][UBound($ScriptViewListArray, 2)]
	EndIf
...
Func DeleteLast()
	If $ScriptViewListArray[0][0] > 0 Then
		ReDim $ScriptViewListArray[$ScriptViewListArray[0][0]][UBound($ScriptViewListArray)]
