...
Func WorkingLoop()
	for $i = 1 to $ScriptViewListArray[0][0] step 1

		next



$ScriptViewListArray[$i][1]
	For $i = 0 To ($ScriptViewListArray[$i][1] * 2) + 2 Step 1
			$NavNodes[$i+1][0] = $ScriptViewListArray[$i][1]
			$NavNodes[$i+1][1] = IniRead($sFileOpenDialog, "NavNodes", "Y" & $i, "")
		Next
