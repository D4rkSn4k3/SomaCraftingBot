...
Func Test()
	...
	Do
		...
		For $e = 1 To 10 Step 1 ; loop through Craft invent to find our mats again
			For $g = 1 To 4 Step 1 ; loop through SA and compare craft bag invent to our SA data
				If $CraftInventoryBag[$e][0] = $SA[$CurrentScriptRow][$g] And $CraftInventoryBag[$i][0] <> 0 Then
					If $SA[$CurrentScriptRow][$g + 4] > $CraftInventoryBag[$e][2] Then ; if there areless mats than the amount
						$NoMoreMats = True
					EndIf
				EndIf
			Next
	...
	MouseUp("Left")
	MsgBox(0, "", "Max BW " & $MaxBagWeight & @CRLF & "inventfull " & $InventFull & @CRLF & "Nomoremats " & $NoMoreMats)
